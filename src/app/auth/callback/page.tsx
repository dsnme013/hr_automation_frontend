...
// //   2. Calls AuthContext.login(token, user) — same as email/password login
// //   3. Pushes router to /dashboard
// // ─────────────────────────────────────────────────────────────────────────────
// "use client";

// import { useEffect, useState } from "react";
// import { useRouter, useSearchParams } from "next/navigation";
// import { useAuth } from "@/services/context/AuthContext";   // ← your AuthContext path
...
//     // JWT payload is base64url-encoded JSON — no external library needed
...
//       };
//     } catch {
//       // JWT decode failed — still proceed, token is usable even without user info
//     }

//     // ── Call AuthContext.login() — this sets state + localStorage correctly ─
//     // This is IDENTICAL to what email/password login does after loginAPI()
//     try {
//       login(token, user);

//       // Also fire auth-changed so Navbar syncs immediately
  ...
  return (
    <Suspense fallback={
      <div style={{
        ...
        <p style={{ fontSize: 14, color: "#5a8a75", margin: 0 }}>
          Completing sign in…
        </p>
