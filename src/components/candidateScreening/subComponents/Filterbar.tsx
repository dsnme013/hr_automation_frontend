...
/**
 * Filter chips mirroring the HTML sidebar exactly.
 * Red Flags (ftab--danger) and Top 10 (ftab--star) are job-scoped:
 *  - Top 10  → top 10 by hybrid score within the selected job
 *  - Red Flags → auto-detected: low score | failed exam | expired | rejected
 */
const STATUS_CHIPS = [
  { label: "All",                 value: "all"                },
  { label: "Shortlisted",         value: "shortlisted"        },
...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  <>
    ...
    <div
      className="sb-sort"
      style={{ padding: "0 0 .45rem", border: "none", marginTop: ".45rem" }}
    >
      <span className="sort-lbl">Sort by</span>
      <div className="sb-sort-wrap">
        <select
